...
jQuery.sap.declare('sap.ui.debug.DebugEnv'); // unresolved dependency added by SAPUI5 CreateModule Ant-Task
...
jQuery.sap.declare('sap.ui.debug.ControlTree'); // unresolved dependency added by SAPUI5 CreateModule Ant-Task
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
...
}; // end of sap/ui/debug/ControlTree.js
...
jQuery.sap.declare('sap.ui.debug.Highlighter'); // unresolved dependency added by SAPUI5 CreateModule Ant-Task
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
...
}; // end of sap/ui/debug/Highlighter.js
...
jQuery.sap.declare('sap.ui.debug.LogViewer'); // unresolved dependency added by SAPUI5 CreateModule Ant-Task
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
...
}; // end of sap/ui/debug/LogViewer.js
...
jQuery.sap.declare('sap.ui.debug.PropertyList'); // unresolved dependency added by SAPUI5 CreateModule Ant-Task
jQuery.sap.require('jquery.sap.global'); // unlisted dependency retained
...
}; // end of sap/ui/debug/PropertyList.js
...
}; // end of sap/ui/debug/DebugEnv.js
